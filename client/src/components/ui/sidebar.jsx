  ...
  ({ className, onClick, ...props }, ref) => {
    ...
    return (
      <Button
        ...
        size="icon"
        className={cn(
          "h-7 w-fit px-2 fixed z-1 left-4 !text-red-900 background-button-hover",
          className
        )}
        onClick={(event) => {
          onClick?.(event);
...
const SidebarContent = React.forwardRef(({ className, ...props }, ref) => {
  return (
    <div
      ...
      className={cn(
        "flex min-h-0 flex-1 flex-col gap-2 overflow-auto group-data-[collapsible=icon]:overflow-hidden bg-white md:bg-transparent",
        className
      )}
      {...props}
    />
